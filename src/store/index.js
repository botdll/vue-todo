...
const INITIAL_DATA = {
    todos: [
        {_id:'1', title:'Walk the dog', description:'Go to the forest near the Zoo'},
        {_id:'2', title:'Buy bread', description:'Whole grain bread would be nice'},
        {_id:'3', title:'Learn programming', description:'Lets learn VueJs'}
    ]
}
